...
if(player ~= nil)then
	...
	if(duckHealthComponent ~= nil and playerHealthComponent ~= nil)then
		...
		ComponentSetValue2(duckHealthComponent, "hp", 20+tonumber(player_hp))
		ComponentSetValue2(duckHealthComponent, "max_hp", 20+tonumber(player_hp))
	end	
else
	ComponentSetValue2(duckHealthComponent, "hp", 20)
	ComponentSetValue2(duckHealthComponent, "max_hp", 20)
end